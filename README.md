<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:1e1e2e,100:b4befe&height=275&section=header&text=Kangaroo&fontSize=70&animation=fadeIn&fontAlignY=35&fontFamily=Ubuntu%20Mono&desc=low-level%20|%20game%20dev&descAlignY=55">


## `LANGUAGES`

![Languages](https://skillicons.dev/icons?i=c,cpp,rust,ocaml,java,bash,haskell,py)
